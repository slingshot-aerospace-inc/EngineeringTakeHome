...
def store_match_results(date, team1, team2, team1_score, team2_score, winner):
  conn = get_database_connection()
  cur = conn.cursor()
  r = cur.execute("INSERT INTO match (date, team1, team2, team1score, team2score, winner) VALUES(%s, %s, %s, %s, %s, %s)",
  ...
  try:
    while True:
      ...
      if not match_exists(date, team1, team2):
        ...
        store_match_results(date, team1, team2, team1_score, team2_score, winner)
